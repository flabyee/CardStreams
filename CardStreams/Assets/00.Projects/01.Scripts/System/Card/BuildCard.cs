...
public class BuildCard : CardPower, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public bool isAccessPlayer;
    public bool isAccessLoopEnd;
    ...
    public void Init(BuildSO buildSO)
    {
        ...
        isAccessCard = buildSO.isAcceseCard;
        isAccessPlayer = buildSO.isAccesePlayer;
        isAccessLoopEnd = buildSO.isAcceseLoopEnd;
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        if(isDrop == true)
        {
            ...
            if(UIManager.Instance != null) UIManager.Instance.playerBuffPanel.Hide();
        }
        else
        {
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        if(isDrop == true)
        {
            ...
            if (UIManager.Instance != null) UIManager.Instance.playerBuffPanel.Show();
        }
        else
        {
